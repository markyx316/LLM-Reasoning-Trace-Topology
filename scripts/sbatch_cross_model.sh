#!/bin/bash
#SBATCH --job-name=x_model
#SBATCH --partition=day
#SBATCH --cpus-per-task=16
#SBATCH --mem=32G
#SBATCH --time=00:30:00
#SBATCH --output=logs/xmodel_%j.out
#SBATCH --error=logs/xmodel_%j.err
...
echo ""
echo "=== Cross-model transfer (Qwen<->Llama) ==="
python src/modeling/cross_model_transfer.py \
    ...
    --output          results/month3/cross_model_transfer.json || exit 10
